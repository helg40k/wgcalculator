...
const ProfileSelector = ({profiles, points}:
                                          {
                                            profiles: {
                                              key: string,
                                              movement: string,
  ...
  const handleSelected = (profile: { key: string, points: number, selected: boolean }) => {
  ...
  return (
    <div className='rounded-xl border-2 mt-2'>
      ...
      <RowSelector rows={profiles} onSelected={handleSelected} content={<SelectorContent data={{
        key: '',
        movement: '',
        attack: '',
        defence: '',
